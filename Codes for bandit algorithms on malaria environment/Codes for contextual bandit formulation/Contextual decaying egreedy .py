...
if __name__ == '__main__':
    ...
    for i, val in enumerate(start_value):
        ...
        data[agent_id] = {'decay_epsilon'[i+1]:val} 
    ...
    plt.title("Training plot for decaying epsilon greedy (contextual)")
    plt.xlabel('episodes')
    plt.ylabel('average episodic reward')
    plt.legend(shadow=True,fancybox=True,framealpha=0.7,loc="best")
    #plt.show()
    plt.savefig('decaying e-greedy_contextual.png')
    
    full_json_dir = "decaying e-greedy_contextual.json"
